...
public class SOSBoardGUI extends JFrame { // constants for grids/cells
    ...
    private gameBoard gameBoardCanvas;
    ...
    class gameBoard extends JPanel {
        ...
        private void drawBoard(Graphics g) { // board for players to interact
        ...
        private void drawLines(Graphics g) { // lines to show players who scored
        ...
        private void printStatusBar() { // let players know status of the game
            if (game.getGameState() == SOSGamemodes.GameState.PLAYING) {
    ...
    public static class TestThread extends Thread { // tests for computers 
    ...
    private void setBoardGUI() { // how GUI will appear to players
        gameBoardCanvas = new gameBoard();
        ...
        confirm.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                try {
        	        ...
        	        JOptionPane.showMessageDialog(null, "Invalid entry please try again."); // ensure player enters valid board size
        	        return;
        	    }
        ...
        sosButton1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                game.setCurrentGamemode(SOSGamemodes.GameType.Simple);
            }
        });
